...
This module defines the personalities for the available AI characters.
Each persona includes specific instructions for tone, style, and language adaptation.

Attributes:
    character_personalities (dict): A dictionary mapping character names to their system prompt strings.
"""
...
def get_character_prompt(name: str) -> str:
    ...
    Args:
        name (str): The name of the character (e.g., 'Sherlock Holmes').

    Returns:
        str: The system prompt associated with the character. 
             Returns the default prompt (Sherlock) if the name is found.
    """
